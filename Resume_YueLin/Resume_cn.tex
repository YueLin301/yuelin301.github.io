...
\resumeSubHeadingListStart
    ...
    {研究方向：多智能体强化学习，信息设计。\\
    有幸师从\href{https://bxiangwang.github.io/}{王趵翔教授}和\href{https://scholar.google.com/citations?user=n1DQMIsAAAAJ&hl=en&oi=ao}{查宏远教授}。\\
    其他密切合作者包括\href{https://ewanlee.weebly.com/}{李文浩教授}和\href{https://cs.uwaterloo.ca/~ppoupart/index.html}{Pascal Poupart 教授}。}
...
\resumeSubHeadingListStart
    ...
    {有幸在\href{https://bxiangwang.github.io/}{王趵翔教授}和\href{https://scholar.google.com/citations?user=n1DQMIsAAAAJ&hl=en&oi=ao}{查宏远教授}的指导下开展研究。}
\resumeSubHeadingListEnd
...
\begin{itemize}[leftmargin=*,itemsep=0pt,topsep=0pt,partopsep=0pt]
    \item Information Design in Multi-Agent Reinforcement Learning. \\
          ...
          \begin{itemize}[itemsep=0pt,topsep=0pt,partopsep=0pt]
              ...
              \item TLDR：提出马尔可夫信号博弈与满足服从约束的信号梯度算法，学习在长期互动中披露哪些信息，使自利的接收者愿意遵循发送者的建议。
          \end{itemize}
    \item Verbalized Bayesian Persuasion. \\
          ...
          \begin{itemize}[itemsep=0pt,topsep=0pt,partopsep=0pt]
              ...
              \item TLDR：提出语言化贝叶斯劝说框架，由大语言模型扮演发送者和接收者，并通过均衡求解器寻找接收者有理由遵循的自然语言信息，且支持多阶段对话。
          \end{itemize}
    \item Policy-Conditioned Policies for Multi-Agent Task Solving. \\
          ...
          \begin{itemize}[itemsep=0pt,topsep=0pt,partopsep=0pt]
              ...
              \item TLDR：将每个智能体的策略表示为可读的源代码，并提出程序化迭代最佳响应，使大语言模型利用博弈收益和单元测试反馈，针对另一策略改写自身的策略代码。
          \end{itemize}
    \item History-Dependent Policy Gradient. \\
          ...
          \begin{itemize}[itemsep=0pt,topsep=0pt,partopsep=0pt]
              ...
              \item TLDR：针对多智能体学习系统的非平稳性，显式考虑其他智能体的历史，并推导出精确的策略梯度。
          \end{itemize}
    \item The Reciprocity Gradient. \\
          ...
          \begin{itemize}[itemsep=0pt,topsep=0pt,partopsep=0pt]
              ...
              \item TLDR：提出互惠梯度，解析追踪行动和评价信号如何沿声誉链传播并回流为未来回报，从而在无需奖励塑形的情况下联合优化二者。
          \end{itemize}
    \item Talk, Judge, Cooperate: Gossip-Driven Indirect Reciprocity in Self-Interested LLM Agents. \\
          ...
          \begin{itemize}[itemsep=0pt,topsep=0pt,partopsep=0pt]
              ...
              \item TLDR：提出去中心化机制 ALIGN，使自利的大语言模型智能体交换开放式、带语气等级的流言，以建立声誉、协调社会规范并孤立背叛者。
          \end{itemize}
    \item Information Bargaining: Bilateral Commitment in Bayesian Persuasion. \\
          ...
          \begin{itemize}[itemsep=0pt,topsep=0pt,partopsep=0pt]
              ...
              \item TLDR：将长期贝叶斯劝说重构为双方均可承诺的双边谈判，从而区分私有信息的价值与率先提议的优势。
          \end{itemize}
    \item Innovative Design and Simulation of a Transformable Robot with Flexibility and Versatility, RHex-T3. \\
          ...
          \begin{itemize}[itemsep=0pt,topsep=0pt,partopsep=0pt]
              ...
              \item TLDR：提出具有两个自由度的可变形 RHex 设计，可在轮、腿、爪和钩等模式间切换，用于高效移动、越障、搬运物体和攀爬梯子。
          \end{itemize}
    \item A snake-inspired path planning algorithm based on reinforcement learning and self-motion for hyper-redundant manipulators. \\
          ...
          \begin{itemize}[itemsep=0pt,topsep=0pt,partopsep=0pt]
              ...
              \item TLDR：提出 Swinging Search and Crawling Control，利用机械臂自运动上的强化学习寻找无碰撞目标构型，再通过爬行抵达目标，而无需搜索每个中间构型。
          \end{itemize}
\end{itemize}
